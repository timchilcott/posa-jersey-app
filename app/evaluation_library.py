...
_DEVELOPMENT_DEFAULTS = {
    ...
    "Dribbling": ("Effective dribblers maintain close control, change direction confidently, and use dribbling to create advantages rather than simply keeping possession.", "Keep the ball close in tight spaces, change speed and direction, use both feet, and practice dribbling across the field at different angles instead of only straight up and down the field.", "Use ball-mastery routines, cone moves, and change-of-direction patterns with both feet. Include sideways and diagonal dribbling across the field to build comfort changing direction under control."),
